...
class MRNConfig:
    def __init__(self, args):
        ...
        self.eval_log_name = f'eval_MRN_mistake_{self.teacher_eps_mistake}_seed_{self.seed}'
        self.train_log_name = f'train_MRN_mistake_{self.teacher_eps_mistake}_seed_{self.seed}'
