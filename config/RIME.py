...
class RIMEConfig:
    def __init__(self, args):
        ...
        self.teacher_beta = -1
        self.teacher_gamma = args.teacher_gamma or 1
        ...
        self.least_reward_update = args.least_reward_update or 5
        ...
        self.threshold_variance = args.threshold_variance or 'kl'
        self.threshold_alpha = args.threshold_alpha or 1.0
        self.feed_type = args.feed_type or 0  # 0: random, 1: uncertainty, 2: entropy
        self.ensemble_size = args.ensemble_size or 3
        self.threshold_beta_init = args.threshold_beta_init or 2.0
        self.threshold_beta_min = args.threshold_beta_min or 0.1
